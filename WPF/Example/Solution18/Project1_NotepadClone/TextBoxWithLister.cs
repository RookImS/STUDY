...
{
    // lister와 텍스트박스를 결합한 형태의 목록을 만드는데 사용하는 클래스
    class TextBoxWithLister : ContentControl
    {
        ...
        // 텍스트 박스 항목과 관련된 프로퍼티로 상황에 따라 입력이 불가능하게 설정할 수 있다.
        public string Text
        {
        ...
        // 키보드를 통해 이 객체가 포커스되면 텍스트박스에 포커스가 설정되도록 만든다.
        ...
        // 첫 문자가 입력되면 lister의 GoToLetter메소드를 사용한다.
